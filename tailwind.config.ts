    ...
    extend: {
      ...
      colors: {
        ...
        background: {
          ...
          dark: '#0D0D0D', // Light Black / Charcoal
      ...
      fontSize: {
        ...
        label: [
          '11px',
          { lineHeight: '1.4', fontWeight: '500', letterSpacing: '0.5px' },
        ],
        caption: ['10px', { lineHeight: '1.3', fontWeight: '500' }],
        // Watchlist specific sizes
        ticker: [
          '13px',
          { lineHeight: '1.2', fontWeight: '600', letterSpacing: '-0.2px' },
        ],
        price: [
          '13px',
          { lineHeight: '1.2', fontWeight: '600', letterSpacing: '-0.35px' },
        ],
