  ...
  return (
    ...
    >
      <div className="bg-card-light dark:bg-card-dark rounded-[24px]
                      ...
                      shadow-[0_4px_24px_rgba(11,31,58,0.07)] dark:shadow-[0_4px_24px_rgba(0,0,0,0.3)]
                      px-6 py-8">
        {/* Title */}
        <h1 className="font-inter font-bold text-[18px] text-text-primary-light dark:text-text-primary-dark text-center">
          Verification Code
        </h1>
        <p className="font-inter text-[12px] text-text-secondary-light dark:text-text-secondary-dark text-center mt-2 mb-7">
            ...
            >
              <input
                ...
                className={cn(
                  ...
                  digit
                    ? "border-primary-DEFAULT dark:border-white/70"
                    : "border-border-light dark:border-[#2a2a2a]",
                  "focus:border-primary-DEFAULT dark:focus:border-white/60"
                )}
        ...
        <motion.button
          ...
          className={cn(
            "w-full h-[50px] rounded-[12px] flex items-center justify-center",
            "font-inter font-bold text-[13px] transition-all duration-200",
            isComplete
              ? "bg-primary-DEFAULT dark:bg-white text-white dark:text-primary-DEFAULT hover:opacity-90"
